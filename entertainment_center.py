...
wonder_woman = media.Movie("Wonder Woman",
                           "Is an movie from 2017, based on the " +
                           "homonym character of DC Comics and " +
...
kingsman = media.Movie("Kingsman",
                       ...
                       "just as a globalthreat emerges from " +
                       "a twisted tech genius",
                       "http://t0.gstatic.com/images?q=tbn:ANd9GcRjbu" +
                       "fWaA7TRXS4z_088Y6PKiIcLsV2wro_fTsQ39PuaI-OQnNf",
